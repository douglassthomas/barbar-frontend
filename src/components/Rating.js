...
class Rating extends Component{
    ...
    render(){
        ...
        let average = (this.props.data.cleanliness+this.props.data.roomf+this.props.data.publicf+this.props.data.security)/4
            ...
            <div style={{
                ...
                <div style={{width:'140px'}}>
                    <div>
                        ...
                        className={average>=1?'fas fa-star':'far fa-star'}></i>
                        <i style={{color:'#ffaa3b'}} 
                        className={average>=2?'fas fa-star':'far fa-star'}></i>
                        <i style={{color:'#ffaa3b'}} 
                        className={average>=3?'fas fa-star':'far fa-star'}></i>
                        <i style={{color:'#ffaa3b'}} 
                        className={average>=4?'fas fa-star':'far fa-star'}></i>
                        <i style={{color:'#ffaa3b'}} 
                        className={average>=5?'fas fa-star':'far fa-star'}></i>
                    </div>
                </div>
